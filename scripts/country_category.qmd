...
country_cat_combined_graph_ready <- country_cat_combined %>% 
    group_by(country, category) %>% 
  summarise(total = sum(count))


stacked_cat_country <- ggplot(data=country_cat_combined_graph_ready, aes(x=country, y=total, fill=category)) +
