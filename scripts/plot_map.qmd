...
geom_with_points <- geom_world + 
  geom_sf(data = data_category_remove_na, 
          aes(color = primary_policy_category_broad), ##plot color by category type
...
ggsave(here::here("images/dates.png"), plot = histogram_dates, width = 7, height = 4, dpi = 320)
